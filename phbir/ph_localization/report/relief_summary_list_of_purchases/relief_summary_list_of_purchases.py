        ...
        for item in item_wise_tax_detail.keys():
            ...
            for item_net_amount in pi_base_net_amounts:                
                if item_net_amount.name == tax_line.name and item_net_amount.item_name == item:
                    ...
                    supplier_row = None
                    supplier_row = next((row for row in data if row.get('supplier') == item_net_amount.supplier), None)
                    # supplier_row = (row for row in data if row.get('supplier') == item_net_amount.supplier)
                    if not supplier_row:
