...
frappe.query_reports["BIR 2306"] = {
	...
	onload: function(report) {
		report.page.add_inner_button(__("Print BIR 2306"), function() {
            let filter_values = {
            ...
            var bir_form_url = frappe.urllib.get_full_url('/api/method/phbir.ph_localization.report.bir_2306.bir_2306.bir_2306?' + u + '&response_type=pdf')
