frappe.provide("phbir.sales_invoice");
...
frappe.ui.form.on('Sales Taxes and Charges', {
    ...
    use_custom_tax_base: function(frm, cdt, cdn){
        ...
        phbir.sales_invoice.calculate_custom_tax_amount(frm, cdt, cdn);
    },

    custom_tax_base: function(frm, cdt, cdn) {
        phbir.sales_invoice.calculate_custom_tax_amount(frm, cdt, cdn);
        phbir.sales_invoice.set_custom_base_tax_base(frm, cdt, cdn);
    },

    form_render: function(frm, cdt, cdn) {
        phbir.sales_invoice.set_dynamic_labels(frm, cdt, cdn);
    },
...
$.extend(phbir.sales_invoice, {
    ...
    set_custom_base_tax_base: function(frm, cdt, cdn) {
        ...
        let df = frappe.meta.get_docfield('Sales Taxes and Charges','custom_base_tax_base', cdn);
        df.hidden = hidden;
